...
<h1 align="center">
    🐉 Draconic
    <br/>
    <pre>@draconic/browserslist-config</pre>
</h1>

> Browserslist configuration tailored for the Draconic Design System.
...
To install the `@draconic/browserslist-config` constant in your project, use the package manager of your choice:

Using [npm](https://www.npmjs.com/):

```shell
npm i -D @draconic/browserslist-config
```

Using [yarn](https://yarnpkg.com/en/):

```shell
yarn add -D @draconic/browserslist-config
```

Using [pnpm](https://pnpm.io/):

```shell
pnpm add -D @draconic/browserslist-config
```
