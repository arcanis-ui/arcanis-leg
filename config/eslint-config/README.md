...
<h1 align="center">
    🐉 Draconic
    <br/>
    <pre>@draconic/eslint-config</pre>
</h1>

> ESLint configuration tailored for the Draconic Design System.
...
To install the `@draconic/eslint-config` constant in your project, use the package manager of your choice:

Using [npm](https://www.npmjs.com/):

```shell
npm i -D @draconic/eslint-config
```

Using [yarn](https://yarnpkg.com/en/):

```shell
yarn add -D @draconic/eslint-config
```

Using [pnpm](https://pnpm.io/):

```shell
pnpm add -D @draconic/eslint-config
```
